...
2 Donghai Laboratory 3 Alibaba Group
...
In-context exemplars (colored
), knowledge (col-
,
) or just Let�s think step by step! are as prompt
ored
(cid:32)
...
GPT-3CodexChatGPTpromptpromptLet's thinkstep by step!?
...
Auto-CoT (Zhang et al., 2023b), Table (Chen, 2022), AlgoPrompt
...
Calibrator (Ye and Durrett, 2022), Human-AI (Wiegreffe et al., 2022)
...
Self-C (Wang et al., 2022e), DIVERSE (Li et al., 2022d), Complexity (Fu et al., 2023b),
Self-V (Weng et al., 2022), MCR (Yoran et al., 2023)

Iterative-Optimization

STaR (Zelikman et al., 2022), LMSI (Huang et al., 2022),
Reflexion (Shinn et al., 2023), Self-Refine (Madaan et al., 2023), REFINER (Paul et al., 2023)

Physical Simulator

Mind�s Eye (Liu et al., 2023)
...
Toolformer (Schick et al., 2023), ART (Paranjape et al., 2023), Chameleon (Lu et al., 2023a)
...
LogicSolver (Yang et al., 2022b), Vote-k (SU et al., 2023), PROMPTPG (Lu et al., 2023b), IRCoT (Trivedi et al., 2022),
RR (He et al., 2023)

Arithmetic

CoT (Wei et al., 2022b), Self-C (Wang et al., 2022e), Least-to-Most (Zhou et al., 2023), ZeroCoT (Kojima et al., 2022), Auto-CoT
...
Faithful (Creswell and Shanahan, 2022), LMLP (Zhang et al., 2022), Self-V (Weng et al., 2022), LAMBADA (Kazemi et al., 2022)
...
are to bring in an optimizer with parameters ? to
...
Q: Roger has 5 tennis balls. He buys 2 more cans  of tennis balls. Each can has 3 tennis balls. He has  5 tennis balls already. He buys 2 � 3 = 6 tennis balls.How many tennis balls does he have now?Q: There are 3 cars in the parking lot and 2more cars arrive. How many cars are in theparking lot? C: There are 3 cars in the parking lot already. 2more arrive. Now there are 3 + 2 = 5 cars. A: The answer is 5.Q: There are 3 cars in the parking lot and 2more cars arrive. How many cars are in theparking lot already? C: There are 3 cars in the parking lot already.How many cars arrive? Q: There are 3 cars in the parking lot and 2 morecars arrive. There are 3 cars in the parking lotalready. 2 cars arrive. How many cars are in theparking lot? C: There  are 3 + 2 = 5 cars in the parking lot. A: The answer is 5.Q: Roger has 5 tennis balls. He buys 2 morecans of tennis balls. Each can has 3 tennisballs. How many tennis balls does he havealready?Q: Roger has 5 tennis balls. He buys 2 morecans of tennis balls. Each can has 3 tennis balls.How many tennis balls does he have now?Q: Roger has 5 tennis balls. He buys 2 morecans of tennis balls. Each can has 3 tennis balls.How many tennis balls does he have now?C: Roger started with 5 balls. 2 cans of 3tennis balls each is 6 tennis balls. 5 + 6 = 11. A: The answer is 11.Language ModelC: We should first know "How many tennisballs does he have already?"Single-StageStage-1...Q: There are 3 cars in the parking lot and 2more cars arrive. How many cars are in theparking lot? C: We should first know "How many cars are inthe parking lot already?" C: He has 5 tennis balls already. How manytennis balls he buys?Stage-2C: He has 5 + 6 = 11 tennis balls now.A: The answer is 11. Language ModelLanguage ModelLanguage ModelStage-nFigure 4: Process Optimization (�3.1.2) of Strategy
...
(cid:32)
answer. Iterative-Optimization (colored
) calibrates
...
Q: There are 3 cars in the parking lot and 2 more cars arrive. How many cars are in the parking lot? C: There are 3 cars in the parking lot already.2 more arrive. Now there are 3 + 2 = 5 cars.A: The answer is 5.LMRoger started with 5balls. 2 cans of 3  tennis balls each is 6tennis balls. 5 + 6 = 11. The answeris 11.The answeris 11.The answeris 7.OptimizerThe answeris 11.Self-OptimizationEnsemble-OptimizationIterative-OptimizationfinetuneQ: Roger has 5 tennis balls. He buys 2more cans of tennis balls. Each can has 3tennis balls. How many tennis balls doeshe have now?Roger has 5 balls already. He buys 2 � 3 = 6 more. So he has 5 + 6 = 11 balls now. Roger has 5 tennis balls. He buys 2 more cans. So he has 5 + 2 = 7 now. Q: Roger has 5 tennis balls. He buys2 more cans of tennis balls. Each canhas 3 tennis balls. How many tennisballs does he have now? PromptLM11ToolsSimulator(e.g., questions) and complex reasoning (e.g., by
...
Q: Roger has 5 tennis balls.He buys 2 more cans of tennisballs. Each can has 3 tennisballs. How many tennis ballsdoes he have now? PromptLMRoger started with 5 balls.2 cans of 3 tennis ballseach is 6 tennis balls. 5 +6 = 11. The answer is 11. LMCorpusCategory
...
POTTER (Rajagopal et al., 2021)
CoT (Wei et al., 2022b)
Auto-CoT (Zhang et al., 2023b)
Least-to-Most (Zhou et al., 2023)

Calibrator (Ye and Durrett, 2022)
Self-Consistency (Wang et al., 2022e)
DIVERSE (Li et al., 2022d)
...
PAL (Gao et al., 2022)
PoT (Chen et al., 2022b)
Toolformer (Schick et al., 2023)

RAINIER (Liu et al., 2022b)
PINTO (Wang et al., 2023)
Fine-tune-CoT (Ho et al., 2022)

PROMPTPG (Lu et al., 2023b)
...
BART/T5
UL2/LaMDA/GPT-3 175B/Codex/PaLM
GPT-3 175B/Codex
GPT-3 175B/Codex
...
10203040506070GPT3-finetuneGPT3-CoTCodex-CoTLaMDA-68B-CoTLaMDA-137B-CoTGSM8KAccuracy(%)Model size540B175B62BPaLM-62B-CoTPaLM-540B-CoTthe major difference between them is the train-
...
Aky�rek et al., 2022), the reason why CoT prompt-
...
of computation or knowledge5. ?prompt allows
...
in-context learning (Xie et al., 2022; Aky�rek et al.,
...
Ekin Aky�rek, Dale Schuurmans, Jacob Andreas,
...
plan, Dong H. Jeong, and Audun J�sang. 2022. A
...
Longo. 2022.
Is neuro-symbolic AI meeting its
...
Manning, Christopher R�, Diana Acosta-Navas,
...
Lucia Zheng, Mert Y�ksekg�n�l, Mirac Suzgun,
...
Raileanu, Baptiste Rozi�re, Timo Schick, Jane
...
Marco T�lio Ribeiro. 2023. ART: automatic multi-
...
Andreas Stuhlm�ller. 2023. Iterated decomposition:
...
CoRR,
models via semantic decompositions.
abs/2212.00193.
...
Gupta, Adri� Garriga-Alonso, Agnieszka Kluska,
...
Stuhlm�ller, Andrew M. Dai, Andrew La, Andrew K.
...
D�dac Sur�s, Sachit Menon, and Carl Vondrick. 2023.
...
KOSMOS-1 (Huang et al., 2023), Visual-ChatGPT (Wu et al., 2023), ViperGPT (Sur�s et al., 2023), MM-REACT (Yang et al., 2023),
...
NumGLUE (Mishra et al., 2022b)
Lila (Mishra et al., 2022a)
...
EntailmentBank (Dalvi et al., 2021)
CLUTRR (Sinha et al., 2019)
DEER (Yang et al., 2022c)

VCR (Zellers et al., 2019)
VisualCOMET (Park et al., 2020)
VLEP (Lei et al., 2020)
PMR (Dong et al., 2022)
ScienseQA (Lu et al., 2022a)
...
405060708090GPT3-CoTCodex-CoTLaMDA-68B-CoTLaMDA-137B-CoTPaLM-62B-CoTCSQAAccuracy(%)Model size540B175B62BPaLM-540B-CoTFigure 10: A test case from GSM8K (Cobbe et al., 2021)
