...
2. Propensity to think out loud.

In cases where models do not strictly need to use CoT to
...
former architecture (Vaswani et al., 2017) that underlies nearly all frontier AI systems, any sufficiently long
...
It is thus
appears in the chain of thought, but there may be other relevant reasoning that does not.
...
chain of thoughtopaque computationTokensLayersInputAttention blocksAttention blocksMLP blocksMLP blocksOutputSoSofivefiveapplesapplesremainremainall dangerous actions will require reasoning to execute, especially as AI systems begin to be routinely trusted
...
In the previous paradigm of pretraining fol-
...
� Measures of CoT readability. For instance, using another LLM to assess the clarity and coher-

ence of CoTs of a given agent.

� Capability evaluations of latent reasoning. These would assess how well LLMs can reason
in a single forward pass), on a variety of reasoning-heavy and agentic

without externalizing (e.g.
tasks.
...
� End-to-end evaluations of monitorability. One could measure monitorability directly, for ex-
ample, by examining how effective CoT monitors are at catching misbehavior of LLM agents in
...
served�for example, through hybrid approaches that maintain some visibility into reasoning while leveraging
latent computation.
...
4 AI Developers Should Track CoT Monitorability of Their Models and Treat it as a
...
observe and report issues. However, this could backfire:
it may lead to significant pressure to directly
...
Iv�n Arcuschin, Jett Janiak, Robert Krzyzanowski, Senthooran Rajamanoharan, Neel Nanda, and Arthur
...
Stephen Casper, Xander Davies, Claudia Shi, Thomas Krendl Gilbert, J�r�my Scheurer, Javier Rando,
Rachel Freedman, Tomek Korbak, David Lindner, Pedro Freire, Tony Tong Wang, Samuel Marks, Charbel-
Raphael Segerie, Micah Carroll, Andi Peng, Phillip J.K. Christoffersen, Mehul Damani, Stewart Slocum,
...
Hobbhahn.
Alignment Fo-
https://www.alignmentforum.org/posts/E3daBewppAiECN3Ao/
...
Ryan Greenblatt, Carson Denison, Benjamin Wright, Fabien Roger, Monte MacDiarmid, Sam Marks, Jo-
hannes Treutlein, Tim Belonax, Jack Chen, David Duvenaud, Akbir Khan, Julian Michael, S�ren Minder-
...
Tomasz Korbak, Hady Elsahar, Germ�n Kruszewski, and Marc Dymetmant. On reinforcement learning and
...
Dustin Li, Esin Durmus, Evan Hubinger, Jackson Kernion, Kamil?e Luko�i�ut?e, Karina Nguyen, Newton
...
Emmons, Sebastian Farquhar, S�bastien Krier, Senthooran Rajamanoharan, Sophie Bridgers, Tobi Ijitoe,
...
Dill, Stefan Heimersheim, Alejandro Ortega, Joseph Bloom, Stella Biderman, Adria Garriga-Alonso,
...
US AI Safety Institute and UK AI Safety Institute. Us aisi and uk aisi joint pre-deployment test: An-
thropic�s claude 3.5 sonnet. Technical report, National Institute of Standards and Technology and UK AI
