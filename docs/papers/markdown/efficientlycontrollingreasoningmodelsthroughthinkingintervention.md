...
Tong Wu1 Chong Xiang2

Jiachen T. Wang1 G. Edward Suh2
...
Demonstration. To further illustrate, consider a general instruction-following task shown in
...
(cid:26)NO_INTERVENE if no intervention is needed at step i

(cid:101)r

if intervention is needed, where

(cid:101)r ? V ?

where x is the input context and r<i represents all reasoning tokens generated up to step i ? 1. The
output sequence
(cid:101)r replaces the existing partial reasoning chain. The modified reasoning generation
...
(cid:101)r can incorporate corrective feedback, alternative reasoning approaches, or relevant domain knowledge
...
(cid:26)NO_INTERVENE if no postfix of r<i matches any string in S,
...
VanillaReminder405060708090100Accuracy (%)55.2661.0061.0062.84No ThinkingIThinkingIVanillaReminder405060708090100Accuracy (%)70.4372.8375.4274.31No ThinkingIThinkingIVanillaReminder405060708090100Accuracy (%)70.4375.2377.0877.63No ThinkingIThinkingIVanillaReminder405060708090100Accuracy (%)79.3081.3382.2682.44No ThinkingIThinkingITable 1: Evaluation results on the SEP dataset across various reasoning models. We compare our
...
405060708090100Safe Request Compliance Rate (%)020406080100Unsafe Request Refusal Rate (%)Compliance VS Refusal RateR1-Qwen-7BR1-Qwen-7B + ThinkingIR1-Qwen-14BR1-Qwen-14B + ThinkingIR1-Qwen-32BR1-Qwen-32B + ThinkingIo3-miniGPT-4o-miniGPT-4o405060708090100Safe Request Compliance Rate (%)020406080100Unsafe Request Refusal Rate (%)Compliance VS Refusal RateVanillaVanilla + ThinkingIDefaultDefault + ThinkingIReminderReminder + ThinkingIGoal PriorityGoal Priority + ThinkingIVanillaDefaultReminderGoal Priority405060708090100Unsafe Request Refusal Rate (%)56.470.076.074.483.387.187.187.8Robustness of SORRY BenchR1-Qwen-32BNo ThinkingIThinkingIGPT-4o-miniGPT-4oo3-miniFigure 6: Attention maps of Prompt Engineering (left)
...
707580859095100Safe Request Compliance Rate (%)020406080100Unsafe Request Refusal Rate (%)Compliance VS Refusal RateNo TITIdefaultTImidTIendTIlongTIsecondTImodelmore sophisticated instructions can theoretically provide richer guidance to models. For instance, we
...
[4] Iv�n Arcuschin, Jett Janiak, Robert Krzyzanowski, Senthooran Rajamanoharan, Neel Nanda,
...
[33] Kenneth Li, Oam Patel, Fernanda Vi�gas, Hanspeter Pfister, and Martin Wattenberg. Inference-
...
[37] Niklas Muennighoff, Zitong Yang, We?ia Shi, Xiang Lisa Li, Li Fei-Fei, Hannaneh Hajishirzi,
...
[40] F�bio Perez and Ian Ribeiro. Ignore previous prompt: Attack techniques for language models.
...
[45] Paul R�ttger, Hannah Kirk, Bertie Vidgen, Giuseppe Attanasio, Federico Bianchi, and Dirk
...
[46] Pranab Sahoo, Ayush Kumar Singh, Sriparna Saha, Vin?a Jain, Samrat Mondal, and Aman
...
[61] Z?un Wang, Haoqin Tu, Yuhan Wang, Juncheng Wu, Jieru Mei, Brian R Bartoldson, Bhavya
...
Vanilla+ThinkingI
Reminder
Reminder+ThinkingI 62.85 (+1.86)
Vanilla
Vanilla+ThinkingI
Reminder
Reminder+ThinkingI 74.31 (+1.48)
Vanilla
Vanilla+ThinkingI
Reminder
Reminder+ThinkingI 77.63 (+2.40)
Vanilla
Vanilla+ThinkingI
Reminder
Reminder+ThinkingI 82.44 (+1.11)
Vanilla
Vanilla+ThinkingI
Reminder
Reminder+ThinkingI 66.17 (+3.32)
Vanilla
Vanilla+ThinkingI
Reminder
Reminder+ThinkingI 82.44 (+0.37)
...
to guide models toward succinct reasoning. For Thinking Intervention, we explicitly inject a
concise instruction ("Okay, the user asked for this. I need to solve it without thinking too
...
405060708090100Safe Request Compliance Rate (%)020406080100Unsafe Request Refusal Rate (%)Compliance VS Refusal RateVanillaVanilla + ThinkingIDefaultDefault + ThinkingIReminderReminder + ThinkingIGoal PriorityGoal Priority + ThinkingI405060708090100Safe Request Compliance Rate (%)020406080100Unsafe Request Refusal Rate (%)Compliance VS Refusal RateVanillaVanilla + ThinkingIDefaultDefault + ThinkingIReminderReminder + ThinkingIGoal PriorityGoal Priority + ThinkingI405060708090100Safe Request Compliance Rate (%)020406080100Unsafe Request Refusal Rate (%)Compliance VS Refusal RateVanillaVanilla + ThinkingIDefaultDefault + ThinkingIReminderReminder + ThinkingIGoal PriorityGoal Priority + ThinkingI405060708090100Safe Request Compliance Rate (%)020406080100Unsafe Request Refusal Rate (%)Compliance VS Refusal RateVanillaVanilla + ThinkingIDefaultDefault + ThinkingIReminderReminder + ThinkingIGoal PriorityGoal Priority + ThinkingI405060708090100Safe Request Compliance Rate (%)020406080100Unsafe Request Refusal Rate (%)Compliance VS Refusal RateVanillaVanilla + ThinkingIDefaultDefault + ThinkingIReminderReminder + ThinkingIGoal PriorityGoal Priority + ThinkingI405060708090100Safe Request Compliance Rate (%)020406080100Unsafe Request Refusal Rate (%)Compliance VS Refusal RateVanillaVanilla + ThinkingIDefaultDefault + ThinkingIReminderReminder + ThinkingIGoal PriorityGoal Priority + ThinkingIFigure 15: Prompt template of evaluating the refusal rate on the SORRY-Bench benchmark. The
{Question} and {Answer} will be filled with the complete prompt and model response, respectively.

Experimental results across multiple reasoning models. We comprehensively evaluate the
...
instruction-and-reasoning pairs that incorporate explicit safety guidelines. Using the publicly
released checkpoint for STAR1-32B, we evaluate its performance on the XSTest and SORRY-Bench
benchmarks.

Integration of Thinking Intervention with Safety Fine-tuning. Figure 17(a) illustrates the
...
VanillaDefaultReminderGoal Priority405060708090100Unsafe Request Refusal Rate (%)60.970.976.476.076.781.884.991.1Robustness of SORRY BenchR1-Qwen-7BNo ThinkingIThinkingIGPT-4o-miniGPT-4oo3-miniVanillaDefaultReminderGoal Priority405060708090100Unsafe Request Refusal Rate (%)59.367.675.874.981.685.683.389.1Robustness of SORRY BenchR1-Qwen-14BNo ThinkingIThinkingIGPT-4o-miniGPT-4oo3-miniVanillaDefaultReminderGoal Priority405060708090100Unsafe Request Refusal Rate (%)56.470.076.074.483.387.187.187.8Robustness of SORRY BenchR1-Qwen-32BNo ThinkingIThinkingIGPT-4o-miniGPT-4oo3-miniVanillaDefaultReminderGoal Priority405060708090100Unsafe Request Refusal Rate (%)62.481.180.983.876.784.783.888.4Robustness of SORRY BenchQwQ-32BNo ThinkingIThinkingIGPT-4o-miniGPT-4oo3-miniVanillaDefaultReminderGoal Priority405060708090100Unsafe Request Refusal Rate (%)56.466.970.773.378.484.788.994.9Robustness of SORRY BenchR1-Llama-8BNo ThinkingIThinkingIGPT-4o-miniGPT-4oo3-miniVanillaDefaultReminderGoal Priority405060708090100Unsafe Request Refusal Rate (%)62.969.178.976.284.487.389.392.0Robustness of SORRY BenchR1-Llama-70BNo ThinkingIThinkingIGPT-4o-miniGPT-4oo3-mini(a) STAR1-32B on XSTest
...
6065707580859095Safe Request Compliance Rate (%)7075808590Unsafe Request Refusal Rate (%)Compliance VS Refusal RateVanillaVanilla + ThinkingIDefaultDefault + ThinkingIReminderReminder + ThinkingIGoal PriorityGoal Priority + ThinkingIVanillaDefaultReminderGoal Priority405060708090100Unsafe Request Refusal Rate (%)83.885.683.885.284.985.885.685.8Robustness of SORRY BenchSTAR1-32BNo ThinkingIThinkingIGPT-4o-miniGPT-4oo3-miniF Design of Thinking Intervention
...
707580859095100Safe Request Compliance Rate (%)020406080100Unsafe Request Refusal Rate (%)Compliance VS Refusal RateVanilla + TIbeginVanilla + TIendDefault + TIbeginDefault + TIendReminder + TIbeginReminder + TIendGoal Priority + TIbeginGoal Priority + TIendVanillaDefaultReminderGoal Priority405060708090100Unsafe Request Refusal Rate (%)83.387.187.887.162.471.677.375.6Robustness of SORRY BenchGPT-4o-miniGPT-4oo3-miniR1-Qwen-32BTIbeginTIend707580859095100Safe Request Compliance Rate (%)020406080100Unsafe Request Refusal Rate (%)Compliance VS Refusal RateVanilla + TIbeginVanilla + TImidDefault + TIbeginDefault + TImidReminder + TIbeginReminder + TImidGoal Priority + TIbeginGoal Priority + TImidVanillaDefaultReminderGoal Priority405060708090100Unsafe Request Refusal Rate (%)83.387.187.887.163.173.678.477.6Robustness of SORRY BenchGPT-4o-miniGPT-4oo3-miniR1-Qwen-32BTIbeginTImidThinking Intervention at reasoning start steers the model more effectively. Figure 18(a) and
...
text content of the Thinking Intervention affects the
We then explore how the different
reasoning process and the final safety performance using the XSTest and SORRY-Bench
benchmarks with the R1-Qwen-32B model. We evaluate two different
intervention se-
quences:
(1) the default shorter intervention sequence (i.e., "I am a helpful, respectful, and
...
tent! So I need to verify the dangerousness of the user�s request."), denoted as TIlong. We
...
707580859095100Safe Request Compliance Rate (%)30405060708090100Unsafe Request Refusal Rate (%)Compliance VS Refusal RateVanilla + TIshortVanilla + TIlongDefault + TIshortDefault + TIlongReminder + TIshortReminder + TIlongGoal Priority + TIshortGoal Priority + TIlongVanillaDefaultReminderGoal Priority405060708090100Unsafe Request Refusal Rate (%)83.387.187.887.193.192.492.990.4Robustness of SORRY BenchGPT-4o-miniGPT-4oo3-miniR1-Qwen-32BTIshortTIlong(a) R1-Qwen-32B on XSTest
...
Reasoning models can self-correct narrative errors. We demonstrate an example from the
...
707580859095100Safe Request Compliance Rate (%)404550556065707580Unsafe Request Refusal Rate (%)Compliance VS Refusal RateVanilla + TIfirstVanilla + TIsecondDefault + TIfirstDefault + TIsecondReminder + TIfirstReminder + TIsecondGoal Priority + TIfirstGoal Priority + TIsecondVanillaDefaultReminderGoal Priority405060708090100Unsafe Request Refusal Rate (%)83.387.187.887.180.283.387.687.1Robustness of SORRY BenchGPT-4o-miniGPT-4oo3-miniR1-Qwen-32BTIfirstTIsecondsubsequent reasoning steps, the model continues using the first-narrative reasoning. This indicates
...
707580859095100Safe Request Compliance Rate (%)404550556065707580Unsafe Request Refusal Rate (%)Compliance VS Refusal RateVanilla + TIdefaultVanilla + TImodelDefault + TIdefaultDefault + TImodelReminder + TIdefaultReminder + TImodelGoal Priority + TIdefaultGoal Priority + TImodelVanillaDefaultReminderGoal Priority405060708090100Unsafe Request Refusal Rate (%)83.387.187.887.183.184.985.884.4Robustness of SORRY BenchGPT-4o-miniGPT-4oo3-miniR1-Qwen-32BTIdefaultTImodelG Case Study of Instruction Hierarchy
